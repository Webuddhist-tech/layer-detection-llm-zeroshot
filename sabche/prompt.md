...
The prompt used for sabche (outline headings) with both Gemini 3.1 Flash Lite and Claude
Sonnet 5.

Every statistic in it was measured on the train and validation books of the sabche split
(294 books, 38,213 spans). The test split was never looked at, and the worked examples are
copied from train and validation books.

Windows, anchors and the locator are the same as for tsawa: 16,000 characters overlapping by
2,000, cut at a shad.
