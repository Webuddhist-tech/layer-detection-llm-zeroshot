#!/usr/bin/env python3
"""Clone the OpenPecha .opf GitHub repos listed in an ID file into <raw-dir>/<PECHA_ID>.opf/.

Each book is its own repo (usually under OpenPecha-Data). The text is at base/v001.txt, often one
level down as <PECHA_ID>.opf/<PECHA_ID>.opf/. A CSV manifest records which ID list each clone
came from and whether it worked. This only fetches; data-rights questions are still open.
"""
